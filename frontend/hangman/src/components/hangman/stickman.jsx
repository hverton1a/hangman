...
{
    return(
        <svg id="eyes" x="10%" y="27%" width="67%" height="12%" >
...
{
    return(
        <circle id="head" cx="36%" cy="30%" r="12%"  stroke="black" strokeWidth="4" fill="none" />
    )
}
...
{
    return(
        <rect id="torso" x="33.3%" y="39%" width="8%" height="29%" stroke="black" fill="black" strokeWidth="0.5%" />
    )
}
